...
| JCP cylinder FP/ESML snapshots | [`legacy_gpu/cylinder_jcp_fp_ml/`](legacy_gpu/cylinder_jcp_fp_ml/) | Unity job-specific exact-FP snapshots and the complete neural-ESML parameter sweep, with hashes and provenance |
