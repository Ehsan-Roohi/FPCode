...
J=$(sbatch --parsable -p cpu -N 1 -n 1 -c 8 -t 02:30:00 --mem=20G -J m70-broad -o "$OUT/logs/m70-broad_%j.out" -e "$OUT/logs/m70-broad_%j.err" --wrap="cd '$ROOT' && python riemann35_patch/stage69_fixed_qmc_blind/run_fixed_case.py --case broad_shifted --output '$OUT' --points-per-component 131072 --replicates 8 --workers 8")
